...
<head>
	...
	<title>@littandart_ | Tamuku</title>
	...
	<div class="wrapper theme-1-active pimary-color-red">
				...
				<div class="nav-header pull-left">
					<div class="logo-wrap">
						<a href="index.html">
							...
							<span class="brand-text">MINASAN</span>
						</a>
					</div>
				</div>
			...
			<div id="mobile_only_nav" class="mobile-only-nav pull-right">
				<ul class="nav navbar-right top-nav pull-right">
					<li class="dropdown auth-drp">
						<!-- /profil atas-->
						<a href="#" class="dropdown-toggle pr-0" data-toggle="dropdown"><?php echo $this->session->userdata('nama'); ?> <img src="./assets/dist/img/jabami.png" alt="user_auth" class="user-auth-img img-circle" /><span class="user-online-status"></span></a>
		...
		<div class="page-wrapper" style="margin-left: 0px;">
			...
			<footer class="footer container-fluid pl-30 pr-30">
				<div class="row">
					<div class="col-sm-12">
					<span>Instagram | <a href="https://instagram.com/littandart_" target="_blank">@littandart_</a></span>
					</div>
				</div>
			</footer>
			<!-- /Footer -->
					...
					success: function (response) {
						if (response.status == 'sukses') {
							...
							swal({
								title: "YATTA!!",
								type: "success",
								text: "Kamu Berhasil Mengiputkan Data",
					...
					success: function (response) { // Ketika proses pengiriman berhasil
						if (response.status == 'sukses') {
							...
							swal({
								title: "YATTA!!",
								type: "success",
								text: "Kamu Berhasil Menghapus Data Ini",
								confirmButtonColor: "#469408"
							});
					...
					success: function (response) { // Ketika proses pengiriman berhasil
						if (response.status == 'sukses') {
							...
							swal({
								title: "YATTA!!",
								type: "success",
								text: "Kamu Telah Berhasil Mengedit Data",
								confirmButtonColor: "#469408"
							});
